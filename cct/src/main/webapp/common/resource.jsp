...
<!--添加的 font -->
<link href="<%=request.getContextPath()%>/webPage/common/css/font-awesome.css" rel="stylesheet" type="text/css" />
<!-- 主题 -->
...
<link href="<%=request.getContextPath()%>/webPage/common/css/css-hack.css" rel="stylesheet" type="text/css" />