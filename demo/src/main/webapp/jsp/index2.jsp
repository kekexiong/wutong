...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md page-sidebar-fixed">
    ...
    <div class="page-container">
    	...
    	<!-- BEGIN MENU -->
        <jsp:include page="./webPage/common/menu.jsp" flush="true"/>
        <!-- END MENU -->
        
        <!-- BEGIN CONTENT -->
        <jsp:include page="./webPage/common/home.jsp" flush="true"/>
        <!-- END CONTENT -->
    </div>
    <!-- END CONTAINER -->
    
    <!-- BEGIN FOOTER -->
    <jsp:include page="./webPage/common/footer.jsp" flush="true"/>
